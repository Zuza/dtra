...
yersinia01_time_bowtie2  = [3.56, 5.15, 34.43, 155.54, 361.64, 366.08]
#yersinia01_time_novoalign= yersinia_read_len_lisa
...
p5,=plot(yersinia_read_len_lisa[0:4], yersinia01_time_bowtie2[0:4])
#p6,=plot(yersinia_read_len_lisa, yersinia01_time_novoalign)
p6,=plot(yersinia_read_len_lisa, yersinia01_time_lisa_lis)
p7,=plot(yersinia_read_len_lisa, yersinia01_time_lisa_cov)

legend([p1,p2,p3,p4,p5,p6,p7], 
       ['BWA-MEM', 'BWA-SW', 'SeqAlto', 'SNAP', 'Bowtie2', 'Lisa-LIS', 'Lisa-COV'], loc=2)
xlabel('Read length')
ylabel('Time [s]')
show()
...
yersinia05_time_bowtie2  = [2.44, 4.95, 33.66, 141.40, 331.54, 308.84]
#yersinia05_time_novoalign= yersinia_read_len_lisa
...
p5,=plot(yersinia_read_len_lisa[0:4], yersinia05_time_bowtie2[0:4])
#p6,=plot(yersinia_read_len_lisa, yersinia05_time_novoalign)
p6,=plot(yersinia_read_len_lisa, yersinia05_time_lisa_lis)
p7,=plot(yersinia_read_len_lisa, yersinia05_time_lisa_cov)
...
yersinia10_time_bowtie2  = [3.24, 4.12, 27.01, 118.24, 288.91, 222.31]
#yersinia10_time_novoalign= yersinia_read_len_lisa
...
p4,=plot(yersinia_read_len_lisa[0:4], yersinia10_time_bowtie2[0:4])
#p5,=plot(yersinia_read_len_lisa, yersinia10_time_novoalign)
p5,=plot(yersinia_read_len_lisa, yersinia10_time_lisa_lis)
p6,=plot(yersinia_read_len_lisa, yersinia10_time_lisa_cov)

legend([p1,p2,p3,p4,p5, p6], 
       ['BWA-MEM', 'BWA-SW', 'SeqAlto', 'Bowtie2', 'Lisa-LIS', 'Lisa-COV'], loc=2)
xlabel('Read length')
ylabel('Time [s]')
show()
